...
这是一个专为智慧教育平台（`https://basic.smartedu.cn/tchMaterial/`）设计的油猴脚本，它允许您一键下载平台上显示的教材PDF文件。通过添加一个便捷的浮动按钮，您可以绕过平台限制，直接保存教材PDF到本地设备。
...
1. 访问智慧教育平台的教材页面（如：`https://basic.smartedu.cn/tchMaterial/...`）
2. **等待PDF完全加载**（重要！）
